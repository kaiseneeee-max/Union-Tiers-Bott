...
// ======================================================
//
// This uses the skin ID you sent:
//
// 6cc743790519ce59
//
// NameMC page:
...
//
// The image endpoint below is used because Discord embeds
// need an image URL rather than a normal NameMC webpage.
// ======================================================

const DEFAULT_SKIN =
  "https://s.namemc.com/3d/skin/body.png?skin=6cc743790519ce59";
...
function getTestingInstructions(kitKey) {
  ...
  return (
    ...
    `The tester decides where the test will be performed.\n\n` +
...
function buildRequestPanel(guildData) {
  const embed = new EmbedBuilder()
    ...
    .setDescription(
      ...
      `🧪 **Testers can manage testing tickets.**`
    )
...
async function createTestingTicket(
  ...
  await channel.send({
    content:
      ...
      `📍 **Testing location:** Tester decides`,
...
function buildResultEmbed({
  ...
  const description =
    ...
    `📍 **Testing Location:** **Decided by Tester**\n\n` +
  ...
  // ====================================================
  //
  // If a skin URL is supplied, use it.
  // Otherwise use your default skin.
  // ====================================================
...
client.once(
  ...
  async () => {
    ...
    try {
      ...
      console.log(
        "✅ Tester decides testing location"
      );
    ...
    try {
      ...
      if (
        ...
        if (type === "results") {
          ...
          return interaction.reply({
            content:
              `✅ Added ${roles.length} role(s) to **both /result and /highresults**.`,
        ...
        if (type === "ticket") {
          ...
          return interaction.reply({
            content:
              `✅ Added ${roles.length} role(s) to **Ticket Access**.\n\n` +

              `🎫 They can now view player testing tickets.\n` +

              `🔒 They can close player testing tickets.`,
