...
// 6cc743790519ce59
//
// Direct 3D body render so Discord can display it.
//

const DEFAULT_SKIN =
  "https://s.namemc.com/3d/skin/body.png?id=6cc743790519ce59&model=classic&width=600&height=800";
    ...
    .addOptions(
      Object.entries(KITS).map(
        ([value, kit]) => ({
          ...
          emoji: kit.emoji,
          description:
            `${kit.rounds} rounds in each world`,
        })
      )
    );
}
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(
      `Select the kit you want to test.\n\n` +
        ...
        `🧪 **Authorized testers/staff can manage tickets.**`
    )
    .setColor(0xffc107);
...
client.once(
  ...
  async () => {
    ...
    try {
      ...
      console.log(
        "✅ Result roles can use BOTH result commands"
      );
  ...
  async (interaction) => {
    try {
      ...
      if (
        ...
        // ================================================
        //
        // RESULT ROLES NOW HAVE ACCESS TO:
        // /result
        // /highresults
        //
        ...
        if (type === "ticket") {
          ...
          return interaction.reply({
            content:
              ...
              `🎫 They can now **view, message in, and close** player tickets.`,
